...
from .views import (RecipeCreateView,
                    ...
                    RecipeListByAuthorView, CategoryCreateView)
...
urlpatterns = [
    ...
    path('list/category/<slug:slug>/', RecipeListByCategoryView.as_view(),
         name='recipe_list_by_category'),
    path('list/author/<str:username>/',
         RecipeListByAuthorView.as_view(), name='recipe_list_by_author'),
